...
d = pd.read_csv("../results/results-f50.csv")
d = d[-d['populism'].isna()]


# TABLE 2

d[["anger","disgust","fear","happy","sad","surprise","neutral","negative"]].describe().round(3).to_csv("../results/f50-emotions-summary.csv")
